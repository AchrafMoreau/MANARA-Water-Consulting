...
export default function middleware(
  ...
  // 2. Skip i18n for ALL API routes (even those with locale prefixes)
...
export const config = {
  matcher: [
    ...
    '/((?!_next|monitoring|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|mp4|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*)',
